...
LIBS=-lmysqlclient -lpcreposix -lresolv -lm  -lpthread -L/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk/usr/lib -lxml2 -lz -lpthread -licucore -lm -L/usr/local/Cellar/pcre/8.38/lib -lpcreposix -lpcre -L/usr/local/mysql-5.7.11-osx10.9-x86_64/lib -lmysqlclient  -liconv
CFLAGS=-D_REENTRANT=1 -I. -Igw -g -O2 -DDARWIN=1 -D_LARGE_FILES= -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk/usr/include/libxml2 -I/usr/local/Cellar/pcre/8.38/include -I/usr/local/mysql-5.7.11-osx10.9-x86_64/include
LDFLAGS=
...
all: progs $(testprogs) $(checkprogs) $(DOCSTARGET) gw-config $(SUBDIRS)
progs: $(progs)
tests: $(testprogs)
docs: figs ps $(docs)
no-docs:
...
gw-config: utils/foobar-config.sh Makefile
	./utils/foobar-config.sh "-I$(includedir)/kannel -g -O2 -DDARWIN=1 -D_LARGE_FILES= -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk/usr/include/libxml2 -I/usr/local/Cellar/pcre/8.38/include -I/usr/local/mysql-5.7.11-osx10.9-x86_64/include" \
		"-L$(libdir)/kannel -lgw -lwap -lgwlib $(LIBS)" \
		"svn-rba2cef5" > gw-config
